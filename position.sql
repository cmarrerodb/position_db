...
CREATE TABLE public.gps_real_time (
    ...
    latencia integer,
    ordenada smallint DEFAULT 1,
    motor smallint DEFAULT 1,
    created_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    updated_at timestamp without time zone,
    deleted_at timestamp without time zone,
);
...
--
-- Name: COLUMN stats_trafic_proveedor_day.dia; Type: COMMENT; Schema: public; Owner: postgres
--

COMMENT ON COLUMN public.stats_trafic_proveedor_day.dia IS 'Dia de la data (1-31)';
...
--
-- Name: COLUMN stats_trafic_proveedor_month.fecha; Type: COMMENT; Schema: public; Owner: postgres
--

COMMENT ON COLUMN public.stats_trafic_proveedor_month.fecha IS 'Fecha de la data';
...
--
-- Name: COLUMN user.perfil_id; Type: COMMENT; Schema: public; Owner: postgres
--
...
--
-- Name: COLUMN user.email_verified_at; Type: COMMENT; Schema: public; Owner: postgres
--
...
--
-- Name: COLUMN user.remember_token; Type: COMMENT; Schema: public; Owner: postgres
--
...
--
-- Name: COLUMN user.bloqueado; Type: COMMENT; Schema: public; Owner: postgres
--
...
--
-- Name: COLUMN user.old_psw; Type: COMMENT; Schema: public; Owner: postgres
--
...
--
-- Name: COLUMN user.two_steps; Type: COMMENT; Schema: public; Owner: postgres
--
...
COPY public.stats_trafic_proveedor_day (id, fecha, cantidad, created_at, updated_at, deleted_at, dia, proveedor_id) FROM stdin;
\.
...
COPY public.stats_trafic_proveedor_month (id, fecha, cantidad, created_at, updated_at, deleted_at, mes, proveedor_id) FROM stdin;
\.
...
COPY public.user (id, perfil_id, name, email, email_verified_at, password, avatar, remember_token, bloqueado, old_psw, two_steps, created_at, updated_at, deleted_at) FROM stdin;
\.
...
--
-- Name: user fk_user_gb_perfiles; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
